  ...
  function initialise(containerSelector, options) {
    ...
    function setAutoScrolling(value, type) {
      ...
      if (options.autoScrolling && !options.scrollBar) {
        ...
        css(container, { "-ms-touch-action": "none", "touch-action": "none" });
        if (element != null) {
        ...
        css(container, { "-ms-touch-action": "", "touch-action": "" });
        if (element != null) {
    ...
    function onMouseEnterOrLeave(e) {
      ...
      normalSelectors.forEach(function (normalSelector) {
        if (closest(e.target, normalSelector) != null) {
          setMouseHijack(document["fp_" + e.type]);
        }
      });
    }
    ...
    function prepareDom() {
      css(container, { height: "100%", position: "relative" });
    ...
    function getFocusables(el) {
      return [].slice
        ...
        .filter(function (item) {
          return (
            item.getAttribute("tabindex") !== "-1" && item.offsetParent !== null
          );
        });
    }
    ...
    function destroyStructure() {
      ...
      css($(SECTION_SEL), { height: "", "background-color": "", padding: "" });
      css($(SLIDE_SEL), { width: "" });
      css(container, {
        height: "",
        position: "",
      ...
      css(container, { "-webkit-transition": "none", transition: "none" });
      window.scrollTo(0, 0);
